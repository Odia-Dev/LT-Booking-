    ...
    <nav className="fixed w-full z-50 bg-white border-b border-gray-200 py-4 transition-all">
      <div className="main-container flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <a href="tel:+9118001234567" className="hidden xl:flex items-center gap-2 text-gray-800 font-bold hover:text-[#ff2b2b] transition-colors bg-gray-50 px-5 py-2.5 rounded-full border border-gray-100">
        ...
        <div className="lg:hidden bg-white border-t border-gray-100 absolute top-full left-0 w-full h-[calc(100vh-80px)] overflow-y-auto p-6 shadow-xl animate-in fade-in duration-200">
          <div className="flex flex-col space-y-6">
            ...
            <a 
              ...
              className="text-center font-bold text-gray-800 bg-gray-50 py-4 rounded-full border border-gray-100 flex items-center justify-center gap-2 mt-4"
            >
