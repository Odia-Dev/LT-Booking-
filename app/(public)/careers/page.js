...
export const metadata = {
  title: 'Careers at Laxmi Toyota',
  description: 'Explore Careers at Laxmi Toyota at Laxmi Toyota.',
};
    ...
    <div className="min-h-screen bg-[#f8f9fa] pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="bg-white p-12 md:p-20 rounded-[2.5rem] border border-gray-100 shadow-sm text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 uppercase italic mb-6">Careers at Laxmi Toyota</h1>
